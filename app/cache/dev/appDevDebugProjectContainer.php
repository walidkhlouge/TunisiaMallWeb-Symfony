...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'hwi_oauth.resource_owner.instagram' => 'getHwiOauth_ResourceOwner_InstagramService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tunisiamallbadr2', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\TunisiaMall\\TMBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\TunisiaMall\\UserBundle\\Entity')));

        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\comment-bundle\\FOS\\CommentBundle\\Resources\\config\\doctrine') => 'FOS\\CommentBundle\\Entity', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine') => 'FOS\\UserBundle\\Entity'));
        $c->setGlobalBasename('mapping');

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'TunisiaMall\\TMBundle\\Entity');
        $d->addDriver($b, 'TunisiaMall\\UserBundle\\Entity');
        $d->addDriver($c, 'FOS\\CommentBundle\\Entity');
        $d->addDriver($c, 'FOS\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('TunisiaMallTMBundle' => 'TunisiaMall\\TMBundle\\Entity', 'FOSCommentBundle' => 'FOS\\CommentBundle\\Entity', 'TunisiaMallUserBundle' => 'TunisiaMall\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity'));
    ...
    {
        return $this->services['fos_comment.form_type.comment.default'] = new \FOS\CommentBundle\Form\CommentType('TunisiaMall\\TunisiaMallTMBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.form_type.commentable_thread.default'] = new \FOS\CommentBundle\Form\CommentableThreadType('TunisiaMall\\TunisiaMallTMBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_comment.form_type.delete_comment.default'] = new \FOS\CommentBundle\Form\DeleteCommentType('TunisiaMall\\TunisiaMallTMBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.form_type.thread.default'] = new \FOS\CommentBundle\Form\ThreadType('TunisiaMall\\TunisiaMallTMBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_comment.manager.comment.default'] = new \FOS\CommentBundle\Entity\CommentManager($this->get('debug.event_dispatcher'), $this->get('fos_comment.sorting_factory'), $this->get('fos_comment.entity_manager'), 'TunisiaMall\\TunisiaMallTMBundle\\Entity\\Comment');
    }
    ...
    {
        return $this->services['fos_comment.manager.thread.default'] = new \FOS\CommentBundle\Entity\ThreadManager($this->get('debug.event_dispatcher'), $this->get('fos_comment.entity_manager'), 'TunisiaMall\\TunisiaMallTMBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('TunisiaMall\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('TunisiaMall\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'TunisiaMall\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.facebook'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\FacebookResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '248369388839956', 'client_secret' => 'fc0160dfaa245ea78fba34b6bbd5b0b3', 'scope' => 'email, basic_info, user_birthday', 'infos_url' => 'https://graph.facebook.com/me?fields=id,email,first_name,last_name,gender,birthday,picture.type(square)', 'paths' => array('profilepicture' => 'picture.data.url'), 'options' => array()), 'facebook', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.google'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\GoogleResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '744233870884-tj7s989ccrmk9odd6mt1rnkvkhv03ua8.apps.googleusercontent.com', 'client_secret' => 'IB7utBnNksRGKCmLbYjHywtr', 'scope' => 'https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile', 'paths' => array(), 'options' => array()), 'google', $this->get('hwi_oauth.storage.session'));
    }

    /**
     * Gets the 'hwi_oauth.resource_owner.instagram' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\InstagramResourceOwner A HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\InstagramResourceOwner instance.
     */
    protected function getHwiOauth_ResourceOwner_InstagramService()
    {
        return $this->services['hwi_oauth.resource_owner.instagram'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\InstagramResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => 'c023c47bdfef408a88fc99f89e9c674b', 'client_secret' => '73ed66282b094604ba55e8bcbe50a7e6', 'scope' => 'public_content', 'paths' => array(), 'options' => array()), 'instagram', $this->get('hwi_oauth.storage.session'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\WindowsLiveResourceOwner A HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\WindowsLiveResourceOwner instance.
     */
    protected function getHwiOauth_ResourceOwner_WindowsLiveService()
    {
        return $this->services['hwi_oauth.resource_owner.windows_live'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\WindowsLiveResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '000000004018F43D', 'client_secret' => 'CTrVHT7RDPFkKbiQHQVebG1WMoIKclb-', 'scope' => 'wl.emails wl.basic wl.signin wl.birthday wl.phone_numbers wl.postal_addresses', 'paths' => array(), 'options' => array()), 'windows_live', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        $this->services['hwi_oauth.resource_ownermap.main'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\ResourceOwnerMap($this->get('security.http_utils'), array('facebook' => 'facebook', 'google' => 'google', 'windows_live' => 'windows_live', 'instagram' => 'instagram'), array('facebook' => '/login/check-facebook', 'google' => '/login/check-google', 'windows_live' => '/login/check-windows_live', 'instagram' => '/login/check-instagram'));
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\framework-extra-bundle/Resources/config/serializer'), 'AppBundle' => ($this->targetDirs[3].'\\src\\AppBundle/Resources/config/serializer'), 'TunisiaMall\\TMBundle' => ($this->targetDirs[3].'\\src\\TunisiaMall\\TMBundle/Resources/config/serializer'), 'blackknight467\\StarRatingBundle' => ($this->targetDirs[3].'\\vendor\\blackknight467\\star-rating-bundle\\blackknight467\\StarRatingBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\rest-bundle\\FOS\\RestBundle/Resources/config/serializer'), 'FOS\\CommentBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\comment-bundle\\FOS\\CommentBundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'\\vendor\\jms\\serializer-bundle\\JMS\\SerializerBundle/Resources/config/serializer'), 'Knp\\Bundle\\PaginatorBundle' => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/config/serializer'), 'HWI\\Bundle\\OAuthBundle' => ($this->targetDirs[3].'\\vendor\\hwi\\oauth-bundle/Resources/config/serializer'), 'TunisiaMall\\UserBundle' => ($this->targetDirs[3].'\\src\\TunisiaMall\\UserBundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/config/serializer'), 'Ob\\HighchartsBundle' => ($this->targetDirs[3].'\\vendor\\ob\\highcharts-bundle/Resources/config/serializer'), 'Nomaya\\SocialBundle' => ($this->targetDirs[3].'\\vendor\\nomaya\\social-bundle\\Nomaya\\SocialBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\DebugBundle/Resources/config/serializer'), 'Acme\\DemoBundle' => ($this->targetDirs[3].'\\src\\Acme\\DemoBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\generator-bundle\\Sensio\\Bundle\\GeneratorBundle/Resources/config/serializer')));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \TunisiaMall\UserBundle\Security\Core\User\FOSUBUserProvider A TunisiaMall\UserBundle\Security\Core\User\FOSUBUserProvider instance.
     */
    protected function getMyUserProviderService()
    {
        return $this->services['my_user_provider'] = new \TunisiaMall\UserBundle\Security\Core\User\FOSUBUserProvider($this->get('fos_user.user_manager'), array('facebook' => 'facebook_id', 'google' => 'google_id', 'twitter' => 'twitter_id', 'github' => 'github_id', 'instagram' => 'instagram_id', 'windows_live' => 'windows_live_id'));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('FOS\\UserBundle\\Model\\UserInterface' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 10))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/livraison');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/client_panier');
        ...
        $n->add($l, array(0 => 'ROLE_CLIENT'), NULL);
        ...
        $r->setOptions(array('login_path' => '/auth', 'default_target_path' => '/client_index', 'always_use_default_target_path' => true, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $s->setOptions(array('login_path' => '/auth', 'failure_path' => '/auth', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $t = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($b, $f, $g, $d, 'main', $r, $s, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true), $a, $c);
        $t->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.main'));
        $t->setCheckPaths(array(0 => '/login/check-facebook', 1 => '/login/check-google', 2 => '/login/check-windows_live', 3 => '/login/check-instagram'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($n, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $a, $c), 2 => $o, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $g, $d, 'main', $p, $q, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => $t, 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5739032ebaf0c7.35435824', $a, $f), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $n, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $d, 'main', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($e, $d, '/auth', false), NULL, NULL, $a));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('contact.tunisiamall@gmail.com');
        $a->setPassword('highping');
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\TunisiaMall\\TMBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\TunisiaMall\\UserBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\TunisiaMall\\TMBundle/Resources/views'), 'TunisiaMallTM');
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\TunisiaMall\\UserBundle/Resources/views'), 'TunisiaMallUser');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TunisiaMallTMBundle' => 'TunisiaMall\\TMBundle\\TunisiaMallTMBundle',
                ...
                'TunisiaMallUserBundle' => 'TunisiaMall\\UserBundle\\TunisiaMallUserBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'tunisiamallbadr2',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'contact.tunisiamall@gmail.com',
            'mailer_password' => 'highping',
            'locale' => 'fr',
            ...
            'security.role_hierarchy.roles' => array(
                ...
                'ROLE_RESPONSABLE_ENSEIGNE' => array(
                    0 => 'ROLE_USER',
                ),
                'ROLE_RESPONSABLE_BOUTIQUE' => array(
                    0 => 'ROLE_USER',
                ),
                'ROLE_CLIENT' => array(
                    0 => 'ROLE_USER',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'contact.tunisiamall@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'highping',
            ...
            'fos_comment.model.thread.class' => 'TunisiaMall\\TunisiaMallTMBundle\\Entity\\Thread',
            'fos_comment.model.comment.class' => 'TunisiaMall\\TunisiaMallTMBundle\\Entity\\Comment',
            ...
            'fos_user.model.user.class' => 'TunisiaMall\\UserBundle\\Entity\\User',
            ...
            'links.facebook' => array(
                'network' => 'facebook',
                'url' => 'http://www.facebook.com/Ben.Bader.M',
                'theme' => 'default',
            ),
