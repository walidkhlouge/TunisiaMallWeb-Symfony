...
class __TwigTemplate_819493cebd2b3688c1c0a9dc1f99a210cf79279b96e31ecfe1dbd8fbb70a1927 extends Twig_Template
{
    ...
    public function block_body3($context, array $blocks = array())
    {
        ...
        echo "       <section id=\"s-clients\" class=\"s-clients bg1\">
                ...
                <div class=\"container\">
                    ...
                    ";
        // line 10
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f"]) ? $context["f"] : $this->getContext($context, "f")), "commentaire", array()), 'widget');
        echo "
                  ";
        // line 11
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["com"]) {
            ...
            echo "                                    <div class=\"swiper-slide rollIn wow client tooltip\">
                                        <div class=\"wrap\">
                                            <img src=\"";
            // line 26
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl((("img/client" . (isset($context["i"]) ? $context["i"] : $this->getContext($context, "i"))) . ".jpg")), "html", null, true);
            echo "\" alt=\"\">
...
\t\t\t\t\t\t\t\t</span>
 ...
 <h4 class=\"b-title ct1 text-center\"> Un Probleme Une Remarque ? ayez la liberte de Tout Reclamer </h4>";
        // line 44
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["f2"]) ? $context["f2"] : $this->getContext($context, "f2")), "reclamation", array()), 'widget');
        echo "
                  ";
        // line 45
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock((isset($context["f2"]) ? $context["f2"] : $this->getContext($context, "f2")), 'rest');
        echo "
                                                                </form>
                  \"";
        // line 47
...
";
    ...
    {
        return array (  112 => 47,  107 => 45,  103 => 44,  89 => 32,  74 => 27,  70 => 26,  66 => 24,  63 => 23,  59 => 22,  54 => 19,  52 => 18,  42 => 11,  38 => 10,  31 => 5,  28 => 4,  11 => 2,);
    }
}
/* */
