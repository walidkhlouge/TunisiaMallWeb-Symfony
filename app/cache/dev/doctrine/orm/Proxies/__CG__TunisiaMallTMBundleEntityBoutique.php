...
class Boutique extends \TunisiaMall\TMBundle\Entity\Boutique implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Boutique' . "\0" . 'idboutique', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Boutique' . "\0" . 'intitule', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Boutique' . "\0" . 'url', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Boutique' . "\0" . 'nomenseigne', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Boutique' . "\0" . 'loginresponsableboutique', 'file'];
        }
