 ...
 */
class Commentaireens extends \TunisiaMall\TMBundle\Entity\Commentaireens implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Commentaireens' . "\0" . 'idcommentaire', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Commentaireens' . "\0" . 'commentaire', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Commentaireens' . "\0" . 'client', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Commentaireens' . "\0" . 'enseigne'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Commentaireens $proxy) {
