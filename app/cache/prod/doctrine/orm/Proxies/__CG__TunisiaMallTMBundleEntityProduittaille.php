 ...
 */
class Produittaille extends \TunisiaMall\TMBundle\Entity\Produittaille implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Produittaille' . "\0" . 'taille', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Produittaille' . "\0" . 'quantite', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Produittaille' . "\0" . 'idproduit'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Produittaille $proxy) {
