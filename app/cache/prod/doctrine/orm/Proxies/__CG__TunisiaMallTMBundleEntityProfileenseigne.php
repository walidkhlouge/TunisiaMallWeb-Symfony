 ...
 */
class Profileenseigne extends \TunisiaMall\TMBundle\Entity\Profileenseigne implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Profileenseigne' . "\0" . 'id', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Profileenseigne' . "\0" . 'url', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Profileenseigne' . "\0" . 'info', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Profileenseigne' . "\0" . 'nomenseigne'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Profileenseigne $proxy) {
