 ...
 */
class Abonnement extends \TunisiaMall\TMBundle\Entity\Abonnement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Abonnement' . "\0" . 'login', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Abonnement' . "\0" . 'nomenseigne'];
        }
     ...
     * {@inheritDoc}
     */
    public function setNomenseigne(\TunisiaMall\TMBundle\Entity\Enseigne $nomenseigne)
    {
