 ...
 */
class Commentairemall extends \TunisiaMall\TMBundle\Entity\Commentairemall implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Commentairemall' . "\0" . 'idcommentairem', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Commentairemall' . "\0" . 'commentaire', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Commentairemall' . "\0" . 'client'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Commentairemall $proxy) {
    ...
    public function getIdcommentairem()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdcommentairem();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdcommentairem', []);

        return parent::getIdcommentairem();
    }
