 ...
 */
class Reclamationmall extends \TunisiaMall\TMBundle\Entity\Reclamationmall implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Reclamationmall' . "\0" . 'idreclamationmall', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Reclamationmall' . "\0" . 'reclamation', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Reclamationmall' . "\0" . 'client'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Reclamationmall $proxy) {
    ...
    public function getIdreclamationmall()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdreclamationmall();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdreclamationmall', []);

        return parent::getIdreclamationmall();
    }
