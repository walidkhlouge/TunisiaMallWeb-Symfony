 ...
 */
class Commentaireproduit extends \TunisiaMall\TMBundle\Entity\Commentaireproduit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Commentaireproduit' . "\0" . 'idcommentaireprod', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Commentaireproduit' . "\0" . 'commentaire', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Commentaireproduit' . "\0" . 'client', '' . "\0" . 'TunisiaMall\\TMBundle\\Entity\\Commentaireproduit' . "\0" . 'idproduit'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Commentaireproduit $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getIdcommentaireprod()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdcommentaireprod();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdcommentaireprod', []);

        return parent::getIdcommentaireprod();
    }
