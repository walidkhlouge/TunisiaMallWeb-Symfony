...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tunisiamallhwi', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    {
        return $this->services['fos_comment.manager.comment.default'] = new \FOS\CommentBundle\Entity\CommentManager($this->get('event_dispatcher'), $this->get('fos_comment.sorting_factory'), $this->get('fos_comment.entity_manager'), 'TunisiaMall\\TunisiaMallTMBundle\\Entity\\Comment');
    }
    protected function getFosComment_Manager_Thread_DefaultService()
    {
        return $this->services['fos_comment.manager.thread.default'] = new \FOS\CommentBundle\Entity\ThreadManager($this->get('event_dispatcher'), $this->get('fos_comment.entity_manager'), 'TunisiaMall\\TunisiaMallTMBundle\\Entity\\Thread');
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'tunisiamall_user_registration', NULL, array('validation_groups' => array(0 => 'Registration', 1 => 'Default')));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $p->setOptions(array('login_path' => '/auth', 'default_target_path' => '/client_index', 'always_use_default_target_path' => true, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        ...
        $q->setOptions(array('login_path' => '/auth', 'failure_path' => '/auth', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_user.registration.form.type' => 'tunisiamall_user_registration',
