...
class __TwigTemplate_94aff63f8a4fefbe994df56a37bf8d35b254ac984aac722c823879cb72944625 extends Twig_Template
{
...
";
    ...
    public function block_rating_widget($context, array $blocks = array())
    {
      ...
      ";
        ...
        $context['_seq'] = twig_ensure_traversable(range(1, (isset($context["stars"]) ? $context["stars"] : null)));
        foreach ($context['_seq'] as $context["_key"] => $context["star"]) {
            // line 10
            echo "          <div id=\"rating_star_";
            echo twig_escape_filter($this->env, (((isset($context["stars"]) ? $context["stars"] : null) - $context["star"]) + 1), "html", null, true);
