...
class __TwigTemplate_e1853da02d5830d9bba9e8cc0b6440fedd624cb94e122f18a4391406fedf0a7d extends Twig_Template
{
...
";
        ...
        if (((isset($context["depth"]) ? $context["depth"] : null) == 0)) {
            ...
            if ($this->env->getExtension('fos_comment')->canCommentThread((isset($context["thread"]) ? $context["thread"] : null))) {
                // line 17
                echo "        ";
                echo $this->env->getExtension('http_kernel')->renderFragment($this->env->getExtension('routing')->getUrl("fos_comment_new_thread_comments", array("id" => $this->getAttribute((isset($context["thread"]) ? $context["thread"] : null), "id", array()))));
                echo "
    ";
            }
            // line 19
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["commentinfo"]) {
            // line 33
            echo "    ";
            $this->loadTemplate("FOSCommentBundle:Thread:comment.html.twig", "FOSCommentBundle:Thread:comments.html.twig", 33)->display(array_merge($context, array("children" => $this->getAttribute($context["commentinfo"], "children", array()), "comment" => $this->getAttribute($context["commentinfo"], "comment", array()), "depth" => (isset($context["depth"]) ? $context["depth"] : null), "view" => (isset($context["view"]) ? $context["view"] : null))));
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
